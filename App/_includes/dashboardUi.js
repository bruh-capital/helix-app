...
export default function dashboardUi(props) {
	return(
		<div className="my-5 grid md:grid-cols-2 space-x-2 space-y-2 md:grid-rows-2 sm:grid-cols-1 sm:grid-rows-4">
		{
			props.protocolData?.map(function (protocol, index) {
				return(
					<div className="card bg-white col-span-1 row-span-1 mt-2 ml-2">
