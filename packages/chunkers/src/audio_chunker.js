...
export default async function AudioChunker(event, uploadFuncCallback){
    ...
    for(var i = 0; i < totalLength; i++){
		...
		//Create a new buffer
		const newBuffer = new AudioContext().createBuffer(audioBuffer.numberOfChannels, computedEnd - computedStart , audioBuffer.sampleRate);
        ...
        uploadFuncCallback(audioBufferToMp3(newBuffer), i == (totalLength-1));
    }
}
