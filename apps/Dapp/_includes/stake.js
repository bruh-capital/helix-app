		...
		<div className="-mt-24 content-center items-center pt-32 md:pt-36 pb-24">
			<div className="flex flex-col sm:px-0 md:px-28 lg:px-50 xl:px-70 2xl:px-96 sm:mx-20 gap-y-8">
				<div className="flex flex-row justify-items-start rounded-xl bg-[#D9D8E2] dark:bg-[#191B1F] border-2 border-[#BABABA] dark:border-[#383838] w-full">
					...
					<div className="text-sx md:text-md font-medium text-[#606060] dark:text-[#7C849A] my-auto whitespace-nowrap truncate text-sm">
				...
				<div className="flex flex-col rounded-xl bg-[#D9D8E2] dark:bg-[#191B1F] border-2 border-[#BABABA] dark:border-[#383838]" >
					...
					<div className="flex flex-col rounded-lg mx-10 md:mx-16 p-4 mb-4 bg-[#C0C0C0] dark:bg-[#212429]">
						...
						<div className="text-xs text-slate-500">
							Total sHLX Received: {protocolData ? amount/(protocolData.shareRatio.toNumber()/1000) : null}
						</div>
