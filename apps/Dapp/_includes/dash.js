				...
				<div className="flex col-span-2 row-span-1 rounded-xl bg-mesh-1-bg bg-cover">
					<div className="flex flex-row px-12 my-auto justify-around align-center w-full">
						<div className="flex flex-col basis-3/4">
							<span className="basis-3/4 text-3xl md:text-4xl xl:text-7xl mb-2 px-6 md:px-0 py-2 font-bold text-white">
								Helix is exclusively available on Solana.
							</span>
							<span className="font-bold text-lg md:text-xl xl:font-3xl">
