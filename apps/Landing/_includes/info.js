...
export default function Info(props) {
	return(
		<div className="flex m-auto bg-gradient-to-tr from-[#5E5FFF] to-[#FB60FF] py-4 md:py-8">
			<div className="flex flex-col items-center justify-center w-full h-full">
				...
				<button className="bg-white py-2 px-6 rounded-full font-sm text-[#5E5FFF]">LEARN MORE</button>
			</div>
		</div>
	);
}