		...
		<div className="flex m-auto bg-gradient-to-tr from-[#0FC5FF] to-[#FE4DC2] py-4 md:py-8">
			<div className="flex flex-col items-center justify-center w-full h-full">
				<Image 
					...
					width={40}
				/>
				<div className="text-white text-sm md:text-xl text-center md:mt-5 mt-1 mb-3 md:mb-4">Can the devs do something?<br/>The Helix team is constantly updating and building!</div>
