			...
			<div className="flex h-screen -mt-44 text-center bg-noblurtokenfallingpreview bg-opacity-50 bg-cover">
				...
				*/}
				<div className="m-auto flex flex-col">
					<span
						className="text-4xl shadow md:text-7xl mb-2 px-6 md:px-0 py-2 font-bold transition-all text-transparent bg-clip-text bg-gradient-to-br from-[#FB60FF] to-[#5E5FFF] animate-gradient-slide"
					>
					...
					<div className="flex m-auto flex-row space-x-4 md:space-x-12">
						...
						<button className="bg-black bg-opacity-70 text-white text-sm md:text-xl px-8 py-4 font-normal border-solid border-4 border-[#FB60FF] rounded-2xl shadow-pink-glow-md ease-in-out duration-150 hover:shadow-pink-glow-lg hover:scale-105">
							Marketplace
							<span className="absolute inline-flex items-center justify-center px-3 py-2 text-sm font-normal leading-none text-white bg-[#FB60FF] rounded-full -translate-y-7 translate-x-1">WIP</span>	
						</button>
					</div>
				</div>
			</div>
