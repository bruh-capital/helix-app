				...
				*/}
				<div className="m-auto flex flex-col">
					...
					<div className="flex m-auto flex-row space-x-4 md:space-x-12">
						<button className="bg-black bg-opacity-70 text-white text-sm md:text-xl px-8 py-4 font-normal border-solid border-4 border-[#59A6F4] rounded-2xl shadow-blue-glow-md ease-in-out duration-150 hover:shadow-blue-glow-lg hover:scale-105">
							Enter App
						</button>
